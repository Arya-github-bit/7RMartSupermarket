...
public class ScreenshotUtility 
{
	public void getScreenShot(WebDriver driver, String failedTestCase) throws IOException {
		TakesScreenshot scrShot = (TakesScreenshot) driver;//creating object for creating screenshot
		java.io.File screenShot = scrShot.getScreenshotAs(OutputType.FILE);//creating variable
